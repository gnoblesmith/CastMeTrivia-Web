			...
			// Default values
			var DEFAULT_POST_ROUND_TIME = 3000; 				// Default length of the post-round timer in ms
			var DEFAULT_ROUND_TIME = 3000; 					// Default length of the round timer in ms
			...
			var m_roundTime; 						// Round timer in ms
			var m_postRoundTime; 					// Post-Round time in ms
			...
			function startPostRoundTimer() {
			    if (m_postround_timer_enable) {
			        ...
			        m_postRoundTimerVar = setInterval(function() {
						var timeLeft = m_postRoundTime - ($.now() - m_postRoundStartTime);
